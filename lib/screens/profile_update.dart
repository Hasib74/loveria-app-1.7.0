  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: mainAppBarWidget(
          title: 'My Profile Update'.toTranslated(), context: context, actionWidgets: []),
      body: FutureBuilder(
          future: _fetchMyData,
          builder: (BuildContext context, AsyncSnapshot snapshot) {
            ...
            List<Widget> tabItems = [
               Padding(
                ...
                child: Tab(text: 'Basic Information'.toTranslated()),
              ),
            ];
            // fixed tab views
            ...
            if (snapshot.hasData &&
              ...
              List phoneCountries = [
                {'name': 'Select Country Code'.toTranslated(), 'phone_code': ''}
              ];
              ...
              print(("userBasicConfigurations['preferred_language'] : ${userBasicConfigurations['preferred_language']}"));
              ...
              tabViews.add(SingleChildScrollView(
                ...
                //    locationUpdateWidget(context),
                    ...
                    /*SelectField(
                      ...
                      labelText: 'Language'.toTranslated(),
                      onChanged: (String? value) {
                    ...
                    InputField(
                      ...
                      labelText: 'About me'.toTranslated(),
                      onChanged: (String? value) {
              ...
              if (data['data']?['specifications'] != null) {
                data['data']['specifications']
                  ...
                  tabItems.add(Padding(
                    ...
                    child: Tab(text: specificationItem['title'].toString().toTranslated()),
                  ));
                  ...
                  for (var item in itemOptions) {
                    ...
                    if (item['input_type'] == 'select') {
                      listOfItems.add(SelectField(
                        ...
                        labelText: item['label'].toString().toTranslated(),
                        onChanged: (String? value) {
...
class BasicInfoWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  Column(
      ...
      children: [
        Center(
          child: Text('Your basic information form will come here.'.toTranslated()),
        )
      ],
    );
  }
